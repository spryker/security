...
class ListenerPrototypeServiceLoader implements ServiceLoaderInterface
{
    ...
    {
        $container->set(static::SERVICE_SECURITY_EXCEPTION_LISTENER_PROTO, $container->protect(function (string $entryPoint, string $firewallName, ?AccessDeniedHandlerInterface $accessDeniedHandler = null) use ($container): callable {
